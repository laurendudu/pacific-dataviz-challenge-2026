...
export const HYPOTHESES = [
  {
    ...
    claim: 'Is it the tourists?',
    measure: 'Tourists per resident, per year.',
    verdict: 'ruled-out',
    reading: '',
  },
  {
    ...
    measure: 'Waste thrown out per person, per day.',
    verdict: 'partial',
    reading: '',
  },
  {
    id: 'electricity_per_capita',
    claim: 'Is it the electricity?',
    measure: 'Electricity generated per person, per year.',
    verdict: 'holds',
    reading: '',
  },
  {
    id: 'capacity_per_capita',
    claim: 'Is it oversized power plants?',
    measure: 'Power station capacity per person.',
    verdict: 'holds',
    reading: '',
  },
  {
    id: 'energy_per_capita',
    claim: 'Is it the energy it burns?',
    measure: 'All energy used per person - fuel as well as electricity.',
    verdict: 'holds',
    reading: '',
  },
  {
    id: 'energy_intensity',
    claim: 'Is it an energy-hungry economy?',
